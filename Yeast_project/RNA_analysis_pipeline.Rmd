...
```{r load data}
abundance <- read.delim(paste("~/GitHub/igem2022/igem2022/Yeast_project/sample_reads/", file_names[1], "/abundance.tsv",
                              sep = ""))
...
for (i in 2:length(files)) {
  tmp <- read.delim(paste("~/GitHub/igem2022/igem2022/Yeast_project/sample_reads/", file_names[i], "/abundance.tsv",
                          sep = ""))
