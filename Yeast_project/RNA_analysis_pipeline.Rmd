...
res_df %>% mutate(nuc_seq = as.character(genome[[annot_dict[strsplit(as.character(Loci), " ")[[1]][2]]]][as.numeric(strsplit(strsplit(as.character(Loci), " ")[[1]][4], "-")[[1]][1]):as.numeric(strsplit(strsplit(as.character(Loci), " ")[[1]][4], "-")[[1]][2])])) # Spaghetti code
```